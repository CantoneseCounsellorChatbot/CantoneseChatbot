...
def main():
    ...
    if args.save_samples_path:
        ...
        samples_file = open(args.save_samples_path + '/mmi_samples.txt', 'w', encoding='utf8')
    ...
    for index_lbk,text in enumerate(test_input):
        if len(text)>70:
            continue
        try:
            text = text.replace("\n","")
            if args.save_samples_path:
                ...
                samples_file.write("gold:{}\n".format(gold_reply[index_lbk]))
            ...
            for response in candidate_responses:
                ...
                samples_file.write("candidate:{} loss:{}\n".format("".join(text)),loss)
                if loss < min_loss:
