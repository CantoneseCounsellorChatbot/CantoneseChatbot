def model_opts(parser):
    ...
    parser.add_argument('-data', type=str, default="", help="pool size of maxout layer")
    parser.add_argument('-logF', type=str, default="", help="pool size of maxout layer")
    parser.add_argument('-testdata', type=str, default="", help="pool size of maxout layer")
    parser.add_argument('-resultF', type=str, default="", help="pool size of maxout layer")
