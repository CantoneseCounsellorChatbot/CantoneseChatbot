...
def main():
    ...
    test_list =  open("/home/kent/githubfile/GPT2-chitchat/data/test_5template.txt").readlines()
    ...
    for index,text in enumerate(test_input):
        ...
        try:
            ...
            gold_reply_list.append("eliza_reply:" + "".join(gold_reply[index]))
            print()
            if args.save_samples_path:
                samples_file.write("chatbot:{}\n".format("".join(text)))
            file_write_obj = open("template5_result.txt", 'w')
